...
// Fade support: apply fade at HDMI output level (no palette corruption)
// fade_level: 0 = full brightness, 64 = full black
// which_rows: bitmask of palette rows to fade (0 = all rows)
