...
// Endianness (SDL2-compatible values)
...
#define SDL_NO_PALETTE 0x40000000u  // Skip palette allocation for surfaces that will adopt an existing palette
...
#define SDL_PIXELFORMAT_RGBA8888 7
